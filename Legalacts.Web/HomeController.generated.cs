    ...
    public partial class HomeController
    {
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                ...
                public readonly string Contact = "Contact";
                public readonly string Feedback = "Feedback";
                public readonly string FeedbackMailTemplate = "FeedbackMailTemplate";
                public readonly string Index = "Index";
            }
            public readonly string About = "~/Views/Home/About.cshtml";
            public readonly string Accessibility = "~/Views/Home/Accessibility.cshtml";
            public readonly string Contact = "~/Views/Home/Contact.cshtml";
            public readonly string Feedback = "~/Views/Home/Feedback.cshtml";
            public readonly string FeedbackMailTemplate = "~/Views/Home/FeedbackMailTemplate.cshtml";
            public readonly string Index = "~/Views/Home/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : Legalacts.Web.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void FeedbackOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Legalacts.Web.Models.FeedbackVM model, bool captchaValid);

        [NonAction]
        public override System.Web.Mvc.ActionResult Feedback(Legalacts.Web.Models.FeedbackVM model, bool captchaValid)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Feedback);
        ...
        [NonAction]
        partial void AccessibilityOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult Accessibility()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Accessibility);
            AccessibilityOverride(callInfo);
            return callInfo;
        }
