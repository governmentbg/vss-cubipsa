...
namespace Legalacts.Web.Captcha
{
    ...
    public sealed class CaptchaValidationAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            var captchaAttribute = filterContext.ActionDescriptor.GetCustomAttributes(typeof(CaptchaValidationAttribute), false).FirstOrDefault() as CaptchaValidationAttribute;
