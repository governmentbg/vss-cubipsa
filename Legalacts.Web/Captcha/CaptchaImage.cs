...
namespace Legalacts.Web.Captcha
{
    ...
    public class CaptchaImage
    {
        ...
        private static readonly Color[] RandomColor = { Color.Black };
        ...
        {
            return System.Drawing.ColorTranslator.FromHtml("#443c41"); //RandomColor[_rand.Next(0, RandomColor.Length)];
        }
